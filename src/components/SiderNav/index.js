...
const menus = [
  ...
  
  {
    ...
    key: '/home/info',
    subs:[
      {key: '/home/info/schoolInfo', title: '信息公开', icon: '',},
      {key: '/home/info/policyInfo', title: '政策法规', icon: '',},
    ]
  },
  {
    title: '平台论坛',
  ...
  render() {
    ...
    return (
      <div style={{height: '100vh',overflowY:'scroll'}}>
        <div style={styles.logo}><img style={{width: '100%', height: '100%'}} src={require('../../assets/img/logo.jpg')} alt=""/></div>
